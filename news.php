  ...
  <main class="w-100 m-0">
    <section class="hero p-0 m-0" data-animate>
      <div class="hero-slide">
        <img src="assets/images/banner.png" alt="NPS news banner" class="hero-slide-image">
        <div class="hero-content container">
          <h1>NPS News &amp; Announcements</h1>
    ...
    <section class="stats-section py-5 text-center text-light" data-animate>
      <div class="container">
        ...
        <div class="row g-3 mt-3 justify-content-center">
          ...
          <div class="col-md-4"><div class="stat-card"><h3>NPS</h3><p>Official Bulletin</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5" id="latest-news" data-animate>
      <div class="container">
        <div class="section-heading">
          ...
          <h1>Latest News</h1>
          <p>Official announcements and updates from New Port Street High School.</p>
        </div>
