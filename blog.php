  ...
  <main>
    <section class="hero p-0 m-0" data-animate>
      <div class="hero-slide">
        <img src="assets/images/banner.png" alt="NPS blog banner" class="hero-slide-image">
        <div class="hero-content container">
          <h1>NPS School Blog</h1>
    ...
    <section class="stats-section py-5 text-center text-light" data-animate>
      <div class="container">
        ...
        <div class="row g-3 mt-3 justify-content-center">
          ...
          <div class="col-md-4"><div class="stat-card"><h3>NPS</h3><p>Community Insights</p></div></div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5" id="blog-posts" data-animate>
      <div class="container">
        <div class="section-heading">
          <span class="section-kicker">NPS Stories</span>
          <h1>School Blog</h1>
        ...
        <div class="news-cards">
          ...
          <?php if (empty($blogPosts)): ?>
            <div class="proprietor-wrap text-center">
              ...
              <p class="mb-0">Blog updates from NPS will appear here once published by the admin.</p>
            </div>
          <?php endif; ?>
        </div>
      </div>
