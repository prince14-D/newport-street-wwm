	...
	<main class="w-100 m-0">
		<section class="hero p-0 m-0" data-animate>
			<div class="hero-slide">
				<img src="assets/images/banner.png" alt="NPS staff banner" class="hero-slide-image">
				...
				<div class="row g-4 justify-content-center">
					<div class="col-sm-6 col-lg-3">
						<div class="admin-card text-center h-100 fade-left">
							<div class="admin-photo-wrap"><img src="assets/images/nps-logo.png" class="team-photo" alt="English teacher"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="admin-card text-center h-100 fade-right">
							<div class="admin-photo-wrap"><img src="assets/images/nps-logo.png" class="team-photo" alt="Mathematics teacher"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="admin-card text-center h-100 fade-left">
							<div class="admin-photo-wrap"><img src="assets/images/nps-logo.png" class="team-photo" alt="Science teacher"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="admin-card text-center h-100 fade-right">
							<div class="admin-photo-wrap"><img src="assets/images/nps-logo.png" class="team-photo" alt="Social studies teacher"></div>
				...
				<div class="row g-4 justify-content-center">
					<div class="col-sm-6 col-lg-3">
						<div class="admin-card text-center h-100">
							<div class="admin-photo-wrap"><img src="assets/images/nps-logo.png" class="team-photo" alt="Office support"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="admin-card text-center h-100">
							<div class="admin-photo-wrap"><img src="assets/images/nps-logo.png" class="team-photo" alt="Security team"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="admin-card text-center h-100">
							<div class="admin-photo-wrap"><img src="assets/images/nps-logo.png" class="team-photo" alt="Custodial team"></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="admin-card text-center h-100">
							<div class="admin-photo-wrap"><img src="assets/images/nps-logo.png" class="team-photo" alt="Library and ICT support"></div>
