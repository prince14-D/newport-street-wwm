    ...
    <section class="stats-section py-5 text-center text-light" data-animate>
      <div class="container">
        ...
        <div class="row g-3 mt-3 justify-content-center">
          ...
          <div class="col-md-4"><div class="stat-card"><h3>NPS</h3><p>Secure Verification</p></div></div>
        </div>
      </div>
    </section>
            ...
            <div class="admin-panel p-4 text-start">
              ...
              <form method="post" class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <input class="form-control" name="transcript_id" value="<?php echo htmlspecialchars($verifyInput['transcript_id']); ?>" placeholder="e.g. NPS-TR-7A91BC3D">
                </div>
                <div class="col-md-6">
