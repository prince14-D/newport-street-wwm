...
<head>
  ...
  <title><?php echo $pageTitle; ?> - NPS Website</title>
  ...
  <main>
    <section class="hero p-0 m-0" data-animate>
      <div class="hero-slide">
        <img src="assets/images/banner3.png" alt="NPS careers banner" class="hero-slide-image">
    ...
    <section class="stats-section py-5 text-center text-light" data-animate>
      <div class="container">
        ...
        <div class="row g-3 mt-3 justify-content-center">
          ...
          <div class="col-md-4"><div class="stat-card"><h3>NPS</h3><p>Professional Growth Culture</p></div></div>
        </div>
      </div>
    </section>
        ...
        <div class="news-cards">
          ...
          <?php if (empty($jobs)): ?>
            <div class="proprietor-wrap text-center">
              ...
              <p class="mb-0">Please check back soon for new employment opportunities at NPS.</p>
            </div>
          <?php endif; ?>
        </div>
