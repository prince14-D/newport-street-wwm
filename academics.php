				...
				<div class="row g-4 align-items-center">
					...
					<div class="col-lg-5 fade-right">
						<div class="verification-cta text-start">
							...
							<a href="assets/uploads/nps-academic-calendar.pdf" class="btn btn-school" download>
					...
					<div class="row g-4 justify-content-center">
						...
						<div class="col-md-6 col-lg-5">
							<div class="download-card fade-right">
								...
								<a href="assets/uploads/nps-information-sheet.pdf" class="btn btn-outline-secondary" download>
