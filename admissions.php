            ...
            <div class="hero-slide">
                ...
                <div class="hero-content container">
                    ...
                    <div class="hero-buttons">
                        ...
                        <a href="assets/uploads/nps-information-sheet.pdf" class="btn light" download>Download Information Sheet</a>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-4">
                        <div class="card p-4 text-start mb-3">
                            ...
                            <form method="post" class="d-grid gap-2">
                                ...
                                <input type="text" class="form-control" name="application_number" placeholder="NPS-ADM-XXXXXXXX" required>
