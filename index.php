		...
		<section class="hero hero-slider">
			<div id="homeHeroCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
				...
				<div class="carousel-inner">
					...
					<div class="carousel-item">
						<div class="hero-slide">
							<img src="assets/images/nps-logo.png" alt="WBI Logo" class="hero-slide-image">
							<div class="hero-content container">
			...
			<div class="container-fluid about-shell">
				<div class="row align-items-center g-3">
					...
					<div class="col-lg-8 text-start fade-right about-copy">
						...
						<p>
							NPS offers quality education from kindergarten to senior high school, combining the Liberian curriculum with
						...
						<p>
							...
							discipline, and service, NPS shapes both mind and heart. From college pathways to trade and ministry,
							NPS remains a strong foundation for future leaders.
						</p>
					...
					<div class="row g-3 align-items-center">
						<div class="col-lg-5 text-center text-lg-start fade-left">
							<div class="proprietor-photo-frame mx-auto mx-lg-0">
								<img src="assets/images/NPS-Principal.png" class="img-fluid proprietor-photo" alt="Principal portrait">
							</div>
						</div>
        ...
        <section class="values section-soft" data-animate>
			<div class="container">
				<div class="section-heading text-center">
					<span class="section-kicker">Our Identity</span>
					<h2>Our Core Values</h2>
					<p>
						At NPS, our values are not only taught in class, they are practiced daily through
			...
			<div class="container">
						...
						<span class="section-kicker">Why Parents Choose NPS</span>
						<h2 class="section-title mb-2">Why Choose NPS?</h2>
			...
			<div class="container">
				...
				<div class="value-cards values-enhanced">
					...
					<article class="card value-card-item partner-card fade-right text-center">
						<div class="partner-logo-badge">
							<img src="assets/images/nps-logo.png" alt="NPS Paynesville branch logo" class="partner-school-logo" loading="lazy" onerror="this.src='assets/images/logo.png'">
						</div>
					...
					<article class="card value-card-item partner-card fade-right text-center">
						<div class="partner-logo-badge">
							<img src="assets/images/nps-logo.png" alt="NPS headquarters logo" class="partner-school-logo" loading="lazy" onerror="this.src='assets/images/logo.png'">
						</div>
						<h3>Headquarters</h3>
